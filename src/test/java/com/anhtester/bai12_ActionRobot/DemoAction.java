package com.anhtester.bai12_ActionRobot;
...
public class DemoAction extends BaseTest {
    ...
    public void inputTextUppercase() throws InterruptedException {
        ...
        action.keyDown(element, Keys.SHIFT).sendKeys("anh tester").keyUp(Keys.SHIFT).sendKeys(" test automation.").build().perform();
    ...
    public void scrollPageDownAndUp() throws InterruptedException {
        ...
        Thread.sleep(1000);
        // Scroll down
        action.keyDown(Keys.END).perform();//nếu đè 2 phím thì dùng build()
    ...
    @Test
    public void copyAndPaste() throws InterruptedException {//lỗi chưa chạy được
